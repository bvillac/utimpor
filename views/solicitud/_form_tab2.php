...
<!--  INICIO DE CONSUMIDOR FINAL-->
<div id="div_Final" class="col-md-12">
    <div class="col-md-12">
...
<!--  FIN DE CONSUMIDOR FINAL-->



<div id="div_Distribuidor" class="col-md-12" style="display: none">
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label for="rbt_op" class="col-sm-3 control-label"><?= Yii::t("perfil", "") ?></label>
            <div class="col-sm-9">
                <label  class="control-label"><?= Yii::t("perfil", "¿Tiene Buró de Crédito?  ") ?></label>
                <label>
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <?=
            Html::dropDownList(
                    "cmb_idforma", 0,   ArrayHelper::map(app\models\Utilities::formaPago(), 'Ids', 'Nombre'), ["class" => "form-control", "id" => "cmb_idforma"]
            )
            ?>
        </div>
